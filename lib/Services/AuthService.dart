...
import 'package:taxi_hayaath/components/OTPDialog.dart';
import 'package:taxi_hayaath/model/UserDetailModel.dart';
import 'package:taxi_hayaath/screens/DriverDashboardScreen.dart';
import 'package:taxi_hayaath/screens/VerifyDeliveryPersonScreen.dart';
      ...
      if (value.data!.uid.isEmptyOrNull) {
        await updateProfile(
          ...
          if (sharedPref.getInt(IS_Verified_Driver) == 1) {
            ...
            launchScreen(getContext, VerifyDeliveryPersonScreen(isShow: true),
                isNewTask: true, pageRouteAnimation: PageRouteAnimation.Slide);
          }
        }).catchError((error) {
          log(error.toString());
