...
import 'package:taxi_hayaath/model/ComplaintModel.dart';
import 'package:taxi_hayaath/model/DriverRatting.dart';
import 'package:taxi_hayaath/model/RideHistory.dart';
import 'package:taxi_hayaath/network/RestApis.dart';
import 'package:taxi_hayaath/screens/RideHistoryScreen.dart';
import 'package:taxi_hayaath/utils/Colors.dart';
import 'package:taxi_hayaath/utils/Extensions/StringExtensions.dart';
import 'package:taxi_hayaath/utils/Extensions/app_common.dart';
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            inkWellWidget(
                              onTap: () {
                                generateInvoiceCall(riderModel,
                                    payment: payment);
                              },
                              child: Row(
                              ...
                              Row(
                                children: [
                                  Icon(FontAwesome.user,
                                      size: 18, color: textPrimaryColorGlobal),
                                  SizedBox(width: 12),
                                  Text(
                      ...
                      children: [
                            ...
                            : Column(
                                children: [
                                  ...
                                  totalCount(
                                      ...
                                      description: '',
                                      subTitle: riderModel!.perDistanceCharge
                                          .toString()),
                                  SizedBox(height: 8),
                                  totalCount(
                        ...
                        payment!.driverTips != 0
                            ? totalCount(
                                ...
                                description: '',
                                subTitle:
                                    '${riderModel!.subtotal! + payment!.driverTips!}',
                                isTotal: true)
                            : totalCount(
                                title: language.total,
                                description: '',
